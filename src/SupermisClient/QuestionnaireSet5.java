...
public class QuestionnaireSet5 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 5";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "5");
					pst1.execute();
					QuestionnaireSet6 q2 = new QuestionnaireSet6();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Fifth Question");
