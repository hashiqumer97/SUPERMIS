...
public class QuestionnaireSet9 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 9";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "9");
					pst1.execute();
					QuestionnaireSet10 q2 = new QuestionnaireSet10();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Ninth Question");
