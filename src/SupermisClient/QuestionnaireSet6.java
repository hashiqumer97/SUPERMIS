...
public class QuestionnaireSet6 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 6";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "6");
					pst1.execute();
					QuestionnaireSet7 q2 = new QuestionnaireSet7();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Sixth Question");
