...
public class QuestionnaireSet14 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 14";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "14");
					pst1.execute();
					JOptionPane.showMessageDialog(null, "Supermis Questionnaire has been completed successfully!");
	...
	JButton question = new JButton("Show Fourteenth Question");
