...
public class QuestionnaireSet7 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 7";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "7");
					pst1.execute();
					QuestionnaireSet8 q2 = new QuestionnaireSet8();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Seventh Question");
