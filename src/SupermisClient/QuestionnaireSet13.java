...
public class QuestionnaireSet13 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 13";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "13");
					pst1.execute();
					QuestionnaireSet14 q2 = new QuestionnaireSet14();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Thirteenth Question");
