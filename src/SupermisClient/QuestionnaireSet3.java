...
public class QuestionnaireSet3 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 3";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "3");
					pst1.execute();
					QuestionnaireSet4 q2 = new QuestionnaireSet4();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Third Question");
