...
public class QuestionnaireSet4 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 4";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "4");
					pst1.execute();
					QuestionnaireSet5 q2 = new QuestionnaireSet5();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Fourth Question");
