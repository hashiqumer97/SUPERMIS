...
public class QuestionnaireSet12 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 12";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "12");
					pst1.execute();
					QuestionnaireSet13 q2 = new QuestionnaireSet13();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Twelfth Question");
