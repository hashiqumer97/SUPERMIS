...
public class QuestionnaireSet10 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 10";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "10");
					pst1.execute();
					QuestionnaireSet11 q2 = new QuestionnaireSet11();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Tenth Question");
