...
public class QuestionnaireSet8 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 8";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "8");
					pst1.execute();
					QuestionnaireSet9 q2 = new QuestionnaireSet9();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Eighth Question");
