...
public class QuestionnaireSet2 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ee) {
		...
		try{
			...
			String sql = "select Q_Questions from question where Q_ID = 2";
...
try{
		...
		if(ee.getSource().equals(yesButton)) { 
			...
			try{
				...
				if(f==true){
					...
					pst1.setString(4, "2");
					pst1.execute();
					QuestionnaireSet3 q2 = new QuestionnaireSet3();
					q2.setVisible(true);
	...
	JButton question = new JButton("Show Second Question");
